...
Database schema definitions can be found from the [`schema.prisma`](api/db/schema.prisma) file in `api/db`. DB models look something like this:
...
This project uses [Prisma](https://www.prisma.io/) as an ORM to talk to the database. Prisma's schema offers a declarative way of defining your app's data models. And Prisma [Migrate](https://www.prisma.io/migrate) uses that schema to make database migrations hassle-free:
